...
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 20000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
//TODO Currency-specific address prefix
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x532f918;
...
const char     CRYPTONOTE_NAME[]                             = "santacoin";
const char     _COINBASE_TX_HEX[]                     = "";
